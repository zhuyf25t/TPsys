...
import services.battle.objects.{BattleMapId, BattleMode, BattlePickupDefinition, BattleVector2, PickupId, PickupKind, WeaponKind}
...
private[services] object BattleMapSpecLoader {
  ...
  private val MapSpecs: Map[BattleMapId, BattleLoadedMapSpec] =
    Vector("default-industrial-arena.json", "fall-hunt-v1.json", "winter-hunt-v1.json", "normal-hunt-v1.json")
      .map(fileName =>
