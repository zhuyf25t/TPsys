import type { Hero, PlayerCommand, Vec2 } from "../../../objects/types";
...
import { isBlinkTargetValid as resolveBlinkTargetValidity } from "../../../runtime/local/movement/blinkTargetResolver";
