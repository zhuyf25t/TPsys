...
import slaydemo.backend.battle.services.runtime.BattleEventFactory.*
...
import slaydemo.backend.battle.services.combat.BattleProjectileTerminalRules.*
import slaydemo.backend.battle.services.runtime.BattleRetentionRules.*
