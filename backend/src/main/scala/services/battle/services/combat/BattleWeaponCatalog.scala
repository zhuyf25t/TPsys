...
private[services] final case class BattleWeaponHeat(value: Int) extends AnyVal
private[services] final case class BattleWeaponHeatRatePerSecond(value: Int) extends AnyVal
