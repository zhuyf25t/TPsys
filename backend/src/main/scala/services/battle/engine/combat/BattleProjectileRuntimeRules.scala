...
import services.battle.engine.BattleProjectileImpactRules.*
import services.battle.engine.BattleProjectileMotionRules.*
import services.battle.engine.BattleProjectileTargetingRules.*
