...
interface HeroWeaponOverlayView {
...
function createHeroWeaponOverlayView(scene: Phaser.Scene, position: Vec2): HeroWeaponOverlayView {
  return {
    primary: scene.add
...
function setHeroWeaponOverlayVisible(view: HeroWeaponOverlayView, visible: boolean): void {
...
interface SyncHeroWeaponOverlayVisualsInput {
...
function syncHeroWeaponOverlayVisuals({
  view,
  weaponKind,
  displayPosition,
  displayFacing,
