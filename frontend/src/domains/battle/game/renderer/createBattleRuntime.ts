...
import type { GameSnapshot, PlayerCommand, PreparedSkill } from "../../objects/types";
import { installWheelSwitchBridge, type WheelSwitchBridge } from "../../runtime/local/input/wheelSwitchAdapter";
import type { AuthoritativeBattleState } from "../../runtime/authoritative/authoritativeBattleClient";
import { GameScene } from "../scenes/GameScene";
import { getSelectedSkillBindings } from "../../api/loadoutGateway";
import { readSkillBindingPresses } from "../../runtime/local/input/skillBindingInputAdapter";
import {
...
/** 中文名：创建战斗runtime（createBattleRuntime）。游戏职责：在前端战斗域中组织战斗界面、状态、输入或渲染数据，保持客户端玩法表达与后端契约一致。 */
