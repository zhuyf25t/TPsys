import type { Hero, ItemPickup, Projectile, SlowField, Vec2, WeaponPickup } from "../../../battle/objects/types";
...
import { applyAutomaticItemPickup, applyAutomaticWeaponPickup } from "../../../battle/runtime/local/pickups/pickupController";
import { type MotionObstacleBounds } from "../../../battle/runtime/local/movement/motionController";
import { advanceMovement } from "../../../battle/runtime/local/movement/movementController";
...
import { getCurrentWeapon, resolveWeaponAction } from "../../../battle/runtime/local/weapons/weaponActionController";
import { resolveBotTactic } from "../strategies/botTactics";
import { getFreezeSpeedMultiplier } from "../../../battle/runtime/local/skills/freezeFieldController";
