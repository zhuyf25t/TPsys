...
export const BATTLE_ARENA_PLAYER_CAPACITY = 4;
export const BATTLE_AUTUMN_ARENA_PLAYER_CAPACITY = 8;
export const BATTLE_WINTER_ARENA_PLAYER_CAPACITY = 6;
export const BATTLE_EXTENDED_ARENA_PLAYER_CAPACITY = BATTLE_AUTUMN_ARENA_PLAYER_CAPACITY;
...
export function battleArenaPlayerCapacityForMode(modeId: BattleModeId | null | undefined): number {
  if (modeId === "autumn") {
    return BATTLE_AUTUMN_ARENA_PLAYER_CAPACITY;
  }

  if (modeId === "winter") {
    return BATTLE_WINTER_ARENA_PLAYER_CAPACITY;
  }

  return BATTLE_ARENA_PLAYER_CAPACITY;
}
