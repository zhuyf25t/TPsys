...
import { type ContributionAdjustmentResult } from "./local/localAdminActionStore";
import type {
  ContributionAdjustmentApiRequestDto,
  ContributionAdjustmentCreateResponseDto,
  ContributionAdjustmentItemResponseDto,
  ContributionAdjustmentListResponseDto,
  GovernanceReviewNotificationApiRequestDto,
  GovernanceReviewNotificationCreateResponseDto,
  GovernanceReviewKindDto,
  GovernanceReviewNotificationItemResponseDto,
  GovernanceReviewNotificationListResponseDto,
  GovernanceReviewTargetTypeDto
} from "../../objects/governance/governanceTypes";
...
export type ContributionAdjustmentRecord = ContributionAdjustmentItemResponseDto;
export type GovernanceReviewKind = GovernanceReviewKindDto;
export type GovernanceReviewTargetType = GovernanceReviewTargetTypeDto;
export type GovernanceReviewNotificationRecord = GovernanceReviewNotificationItemResponseDto;
...
type RemoteContributionAdjustmentResponse =
  Partial<Record<keyof ContributionAdjustmentListResponseDto, unknown>> &
  Partial<Record<keyof ContributionAdjustmentCreateResponseDto, unknown>>;

type RemoteGovernanceReviewNotificationResponse =
  Partial<Record<keyof GovernanceReviewNotificationListResponseDto, unknown>> &
  Partial<Record<keyof GovernanceReviewNotificationCreateResponseDto, unknown>>;
...
export async function recordContributionAdjustment(input: {
  ...
  const payload: ContributionAdjustmentApiRequestDto = {
...
export async function submitGovernanceReviewNotification(input: {
  ...
  const payload: GovernanceReviewNotificationApiRequestDto = {
    actorHandle: input.actorHandle ?? "",
    kind: input.kind,
...
function isGovernanceReviewTargetType(value: string): value is GovernanceReviewTargetType {
