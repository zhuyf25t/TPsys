...
export interface BattlePlayerMovementInput {
  alive: boolean;
...
export interface BattlePlayerMovementResult {
  velocity: Vec2;
  stamina: number;
  lastMoveDirection: Vec2;
}
...
export function advanceMovement(input: BattlePlayerMovementInput): BattlePlayerMovementResult {
