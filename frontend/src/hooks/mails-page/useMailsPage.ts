...
import { CONTRIBUTION_ADJUSTMENTS_CHANGED_EVENT, loadContributionAdjustments } from "../../api/governance/governanceGateway";
...
import { loadRemoteFriendRequests, respondToFriendRequest, type FriendRequestDecision } from "../../api/social/friendRequestGateway";

export type { FriendRequestDecision } from "../../api/social/friendRequestGateway";
export type { FriendRequestMailStatus, MailSummary } from "../../api/mail/mailsGateway";
