...
| `ForumCommandParsers.scala` | 已迁到 `forum/objects/apiTypes`，forum request body 到 create/reply/vote command 的转换已由 `ForumApiTypes.scala` 承接；`ForumHttp4sRoutes` 仅保留 topic id path 解析调用。 |
