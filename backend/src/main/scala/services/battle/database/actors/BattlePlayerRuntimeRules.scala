...
import services.battle.database.actors.BattleBotRules.*
...
import services.battle.database.combat.BattleWeaponCatalog
import services.battle.database.world.{BattleArenaCatalog, BattleMovementCatalog}
