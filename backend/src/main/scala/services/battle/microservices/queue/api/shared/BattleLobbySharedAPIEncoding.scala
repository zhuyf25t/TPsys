...
object BattleQueueParticipantAPIEncoding {
...
object BattleRoomChatMessageAPIEncoding {
...
object BattleSessionRosterEntryAPIEncoding {
...
object BattleSessionBootstrapSeatAPIEncoding {
...
object BattleSessionBootstrapAPIEncoding {
  import BattleSessionBootstrapSeatAPIEncoding.given

  given Encoder[BattleSessionBootstrap] =
    Encoder.forProduct1("seats")(_.seats)
}

object BattleSessionDescriptorAPIEncoding {
  import BattleSessionBootstrapAPIEncoding.given
  import BattleSessionRosterEntryAPIEncoding.given
