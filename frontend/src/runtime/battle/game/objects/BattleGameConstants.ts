import type { BattleTeamMode as TeamMode, BattleVector2 as Vec2 } from "../../../../objects/battle/objects/core/BattleCoreScalars";
import type { WeaponKind } from "../../../../objects/battle/microservices/combat/objects/weapon/WeaponKind";
import { DEFAULT_BATTLE_MAP, getActiveBattleMap, type ArenaObstacle } from "../../microservices/world/services/BattleArenaCatalog";
...
export type { ArenaObstacle, BattleMapThemeId } from "../../microservices/world/services/BattleArenaCatalog";
...
export const BOSS_ZOMBIE_TEXTURE_KEY = "hero-zombie-boss";
...
export const ASSET_PATHS = {
  ...
  zombie: "/assets/kenney-top-down-shooter/PNG/Zombie 1/zoimbie1_stand.png",
  zombieBoss: "/assets/kenney-top-down-shooter/PNG/Zombie 1/zoimbie1_hold.png"
} as const;
...
export const WINTER_ASSET_PATHS = {
  ...
  "winter-rock-4": "/assets/battle/winter/obstacles/rock_4.svg",
  "winter-rock-5": "/assets/battle/winter/obstacles/rock_5.svg",
  "winter-rock-6": "/assets/battle/winter/obstacles/rock_6.svg",
  "winter-rock-7": "/assets/battle/winter/obstacles/rock_7.svg",
  "winter-frozen-crate-1": "/assets/battle/winter/obstacles/frozen_crate_1.svg",
  "winter-frozen-crate-2": "/assets/battle/winter/obstacles/frozen_crate_2.svg",
  "winter-regular-crate-1": "/assets/battle/winter/obstacles/regular_crate_winter_1.svg",
  "winter-regular-crate-2": "/assets/battle/winter/obstacles/regular_crate_winter_2.svg",
  "winter-regular-crate-3": "/assets/battle/winter/obstacles/regular_crate_winter_3.svg",
  "winter-regular-crate-4": "/assets/battle/winter/obstacles/regular_crate_winter_4.svg",
  "winter-regular-crate-5": "/assets/battle/winter/obstacles/regular_crate_winter_5.svg",
  "winter-regular-crate-6": "/assets/battle/winter/obstacles/regular_crate_winter_6.svg",
  "winter-aegis-crate-1": "/assets/battle/winter/obstacles/aegis_crate_winter_1.svg",
  "winter-aegis-crate-2": "/assets/battle/winter/obstacles/aegis_crate_winter_2.svg",
  "winter-aegis-crate-3": "/assets/battle/winter/obstacles/aegis_crate_winter_3.svg",
  "winter-barrel-1": "/assets/battle/winter/obstacles/barrel_winter_1.svg",
  "winter-barrel-2": "/assets/battle/winter/obstacles/barrel_winter_2.svg",
  "winter-barrel-3": "/assets/battle/winter/obstacles/barrel_winter_3.svg",
  "winter-sandbags": "/assets/battle/winter/obstacles/sandbags_winter.svg",
  "winter-smaller-sandbags": "/assets/battle/winter/obstacles/smaller_sandbags_winter.svg",
  "winter-roadblock": "/assets/battle/winter/obstacles/roadblock_winter.svg",
  "winter-truck": "/assets/battle/winter/obstacles/truck.svg",
  "winter-truck-front-1": "/assets/battle/winter/obstacles/truck_front_winter_1.svg",
  "winter-truck-front-2": "/assets/battle/winter/obstacles/truck_front_winter_2.svg",
  "winter-m1117-1": "/assets/battle/winter/obstacles/m1117_1.svg",
  "winter-m1117-2": "/assets/battle/winter/obstacles/m1117_2.svg",
  "winter-generator": "/assets/battle/winter/obstacles/generator_winter.svg",
  "winter-forklift": "/assets/battle/winter/obstacles/forklift_winter.svg",
  "winter-oil-tank-1": "/assets/battle/winter/obstacles/oil_tank_winter_1.svg",
  "winter-oil-tank-2": "/assets/battle/winter/obstacles/oil_tank_winter_2.svg",
  "winter-ice-pick-case": "/assets/battle/winter/obstacles/ice_pick_case.svg",
  "winter-gun-case-1": "/assets/battle/winter/obstacles/gun_case_winter_1.svg",
  "winter-gun-case-2": "/assets/battle/winter/obstacles/gun_case_winter_2.svg",
  "winter-river-chest": "/assets/battle/winter/obstacles/river_chest.svg",
  "winter-christmas-tree": "/assets/battle/winter/obstacles/christmas_tree.svg",
  "winter-poinsettia": "/assets/battle/winter/obstacles/poinsettia.svg",
  "winter-gold-airdrop-crate": "/assets/battle/winter/obstacles/gold_airdrop_crate.svg",
  "winter-airdrop-crate": "/assets/battle/winter/obstacles/airdrop_crate.svg",
  "winter-planted-bushes-shared": "/assets/battle/winter/obstacles/planted_bushes.svg",
  "winter-red-house-roof": "/assets/battle/winter/buildings/red_house_ceiling.svg",
  "winter-blue-house-roof": "/assets/battle/winter/buildings/blue_house_ceiling.svg",
  "winter-green-house-roof-1": "/assets/battle/winter/buildings/green_house_ceiling_1.svg",
  "winter-green-house-roof-2": "/assets/battle/winter/buildings/green_house_ceiling_2.svg",
  "winter-igloo-roof-1": "/assets/battle/winter/buildings/igloo_ceiling_1.svg",
  "winter-igloo-roof-2": "/assets/battle/winter/buildings/igloo_ceiling_2.svg",
  "winter-igloo-floor": "/assets/battle/winter/buildings/igloo_floor.svg",
  "winter-warehouse-roof-1": "/assets/battle/winter/buildings/warehouse_ceiling_1.svg",
  "winter-warehouse-roof-2": "/assets/battle/winter/buildings/warehouse_ceiling_2.svg",
  "winter-large-warehouse-roof": "/assets/battle/winter/buildings/large_warehouse_ceiling.svg",
  "winter-armory-center-roof-1": "/assets/battle/winter/buildings/armory_center_ceiling_1.svg",
  "winter-armory-center-roof-2": "/assets/battle/winter/buildings/armory_center_ceiling_2.svg",
  "winter-armory-barracks-roof-1": "/assets/battle/winter/buildings/armory_barracks_ceiling_1.svg",
  "winter-armory-barracks-roof-2": "/assets/battle/winter/buildings/armory_barracks_ceiling_2.svg",
  "winter-armory-vault-roof": "/assets/battle/winter/buildings/armory_vault_ceiling.svg",
  "winter-port-main-office-roof-1": "/assets/battle/winter/buildings/port_main_office_ceiling_1.svg",
  "winter-port-main-office-roof-2": "/assets/battle/winter/buildings/port_main_office_ceiling_2.svg",
  "winter-port-gate-office-roof": "/assets/battle/winter/buildings/port_gate_office_ceiling.svg",
  "winter-river-hut-roof": "/assets/battle/winter/buildings/river_hut_ceiling.svg",
  "winter-mobile-home-roof": "/assets/battle/winter/buildings/mobile_home_ceiling.svg",
  "winter-refinery-roof-1": "/assets/battle/winter/buildings/refinery_ceiling_1.svg",
  "winter-refinery-roof-2": "/assets/battle/winter/buildings/refinery_ceiling_2.svg",
  "winter-construction-floor-left": "/assets/battle/winter/buildings/construction_site_floor_1_left.svg",
  "winter-construction-floor-right": "/assets/battle/winter/buildings/construction_site_floor_1_right.svg",
  "winter-cargo-floor-bottom-1": "/assets/battle/winter/buildings/cargo_ship_floor_bottom_1.svg",
  "winter-cargo-floor-bottom-2": "/assets/battle/winter/buildings/cargo_ship_floor_bottom_2.svg"
} as const;

export const SUROI_ZOMBIE_ASSET_PATHS = {
  "suroi-zombie-airdrop-plane": "/assets/battle/suroi-zombie/airdrop_plane.svg",
  "suroi-zombie-lab-floor": "/assets/battle/suroi-zombie/medical_camp_lab_floor.svg",
  "suroi-zombie-lab-ceiling": "/assets/battle/suroi-zombie/medical_camp_lab_ceiling.svg",
  "suroi-zombie-large-medical-bed": "/assets/battle/suroi-zombie/large_medical_bed.svg",
  "suroi-zombie-small-medical-bed": "/assets/battle/suroi-zombie/small_medical_bed.svg",
  "suroi-zombie-hazel-crate": "/assets/battle/suroi-zombie/hazel_crate.svg",
  "suroi-zombie-blood-decal": "/assets/battle/suroi-zombie/blood_decal.svg",
  "suroi-zombie-explosion-decal": "/assets/battle/suroi-zombie/explosion_decal.svg",
  "suroi-zombie-used-flare": "/assets/battle/suroi-zombie/used_flare_decal.svg"
} as const;
...
export const HERO_TEXTURE_KEYS = {
  ...
  "bot-1": BOSS_ZOMBIE_TEXTURE_KEY,
  "bot-2": BOSS_ZOMBIE_TEXTURE_KEY,
  "bot-3": BOSS_ZOMBIE_TEXTURE_KEY,
  "bot-4": ZOMBIE_TEXTURE_KEY,
  "bot-5": ZOMBIE_TEXTURE_KEY,
  "bot-6": ZOMBIE_TEXTURE_KEY,
  "bot-7": ZOMBIE_TEXTURE_KEY,
  "bot-8": ZOMBIE_TEXTURE_KEY,
  "bot-9": ZOMBIE_TEXTURE_KEY,
  "bot-10": ZOMBIE_TEXTURE_KEY,
  "bot-11": ZOMBIE_TEXTURE_KEY
} as const;
