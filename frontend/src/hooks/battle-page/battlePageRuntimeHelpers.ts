...
import { isBattleComplete, isLocalPlayerEliminated } from "../../runtime/battle/local/session/battleCompletion";
...
} from "../../runtime/battle/local/session/botOnlyBattleClosure";
