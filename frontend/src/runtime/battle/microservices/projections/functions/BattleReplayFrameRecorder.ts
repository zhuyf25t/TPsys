...
import type {
  BattleReplayFrameState as ReplayFrame,
  BattleReplayHeroFrameState as ReplayHeroFrame,
  BattleReplayPickupFrameState as ReplayPickupFrame,
  BattleReplayProjectileFrameState as ReplayProjectileFrame
} from "../../../../../objects/battle/microservices/projections/objects/replay/BattleReplayFrameState";
...
function toReplayPickupFrame(
  ...
  return {
    id: pickup.pickupId,
    kind: "weaponKind" in pickup ? "weapon" : "medkit",
    position: { ...pickup.position },
    available: pickup.available
  };
}
