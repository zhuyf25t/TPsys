...
import services.battle.microservices.combat.objects.weapon.{AmmoCount, BattleWeaponHeat}
...
import services.battle.microservices.combat.objects.weapon.BattleWeaponState
