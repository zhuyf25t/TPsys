import type { SkillKind } from "../../objects/battle/types";
import { getCurrentAuthHandle, getCurrentAuthSkin, updateCurrentAuthSkin } from "../identity/authGateway";
import { getRatingEntryByHandle } from "../governance/ratingGateway";
