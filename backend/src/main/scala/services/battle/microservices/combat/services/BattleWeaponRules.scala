...
private[battle] object BattleWeaponRules {
  ...
  def createWeaponState(weaponKind: WeaponKind): BattleWeaponState = {
    val definition = inventoryDefinition(weaponKind)
    BattleWeaponState(
  ...
  def refillWeaponState(weapon: BattleWeaponState): BattleWeaponState = {
    val definition = inventoryDefinition(weapon.weaponKind)
