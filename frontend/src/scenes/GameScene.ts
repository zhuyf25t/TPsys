...
import type { GameSnapshot, Hero, PlayerCommand, PreparedSkill, Vec2 } from "../domain/types";
import { buildArena, type ObstacleBounds, type OccludableView } from "../features/battle/renderer/arena/arenaBuilder";
import { createWorldViewState, type HeroView, type WorldViewState } from "../features/battle/renderer/entities/worldViewFactory";
...
import { getPlayerHeroFromSnapshot } from "../features/battle/renderer/snapshot/playerHeroLookup";
...
import type { BattleFeedbackSceneBridge } from "../features/battle/renderer/effects/battleFeedbackSceneBridge";
import type { SharedAuthoritativeLocalFeedbackSceneBridge } from "../features/battle/renderer/effects/sharedAuthoritativeLocalFeedbackSceneBridge";
...
import { WeaponSwitchStateBridge } from "../features/battle/runtime-local/weapons/weaponSwitchStateBridge";
import { WeaponWheelSwitchSceneBridge } from "../features/battle/runtime-local/weapons/weaponWheelSwitchSceneBridge";
import { createProjectileSequenceBridge } from "../features/battle/runtime-local/projectiles/projectileSequenceBridge";
import {
  AuthoritativeFrameSceneBridge,
  type GameSceneAuthoritativeFrame,
  type GameSceneAuthoritativeFrameOptions
} from "../features/battle/renderer/authoritativeFrameSceneBridge";
import { LocalHeroDisplay } from "../features/battle/renderer/localHeroDisplayPose";
import { LocalBattleFrameSceneBridge } from "../features/battle/runtime-local/session/localBattleFrameSceneBridge";
import { getHeroBasePresentationScale } from "../features/battle/renderer/entities/heroPresentationScale";
import {
  renderGameSceneHud,
  syncGameSceneWorldViews,
  updateGameSceneOcclusion
} from "../features/battle/renderer/gameScenePresentationBridge";
import { createGameScenePlayerActor, flashGameSceneHero } from "../features/battle/renderer/gameSceneHeroActorBridge";
import {
...
} from "../features/battle/renderer/gameSceneFeedbackBridgeFactory";
