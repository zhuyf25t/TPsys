...
private[results] object BattleResultFileJsonParser {
...
private[results] final case class BattleResultFileJsonPayload(
  schema: String,
...
private[results] object BattleResultFileJsonPayload {
...
private[results] final case class BattleResultFileRecordJson(
  battleId: String,
...
private[results] object BattleResultFileRecordJson {
