...
export type SkillCommandField = Extract<keyof PlayerCommand, "castDash" | "castCritical" | "toggleBlink" | "toggleFreeze">;
...
const CRITICAL_REJECTION_FEEDBACK_RADIUS = 26;
...
export const SKILL_RUNTIME_PROFILES = {
  ...
  Critical: {
    kind: "Critical",
    activationKind: "instant",
    commandField: "castCritical",
    feedback: {
      rejectionRadius: CRITICAL_REJECTION_FEEDBACK_RADIUS
    }
  }
} as const satisfies {
  ...
  readonly Critical: InstantSkillRuntimeProfile<"Critical">;
};
