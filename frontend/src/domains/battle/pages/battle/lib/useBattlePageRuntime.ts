...
import type { GameSnapshot, PlayerCommand, PreparedSkill, Vec2 } from "../../../objects/types";
import {
...
} from "../../../runtime/authoritative/authoritativeBattleClient";
import {
  BATTLE_MATCH_DURATION_MS,
  finalizeLocalBattle,
  type LocalBattleReturnSummary
} from "../../../runtime/local/state/battleLocalGateway";
import { createBattleRuntime, type BattleRuntimeHandle } from "../../../game/renderer/createBattleRuntime";
import {
...
} from "../../../runtime/matchmaking/matchmakingQueueGateway";
import { type MatchmakingQueueState } from "../../../runtime/matchmaking/matchmakingQueueTypes";
import {
  hasSharedBattleSession,
  resolveSharedQueueRemainingMs
} from "../../../runtime/matchmaking/multiplayerRoomTiming";
import { buildReplayFrame, REPLAY_SAMPLE_INTERVAL_MS, shouldCaptureReplayFrame } from "../../../../replay/objects/replayRecorder";
...
import { loadBattleResultByBattleId } from "../../../api/battleResultsApi";
