import type { Hero, PlayerCommand, Projectile, Vec2 } from "../../../../domain/types";
import { WEAPON_DEFINITIONS } from "../../../../game/weapons";
import { presentWeaponActionPlan } from "./weaponActionPlanPresenter";
import { getCurrentWeapon, resolveWeaponAction } from "../../runtime-local/weapons/weaponActionController";
  ...
  public handleWeaponFireAction(command: PlayerCommand): void {
    ...
    presentWeaponActionPlan({
      ...
      callbacks: {
        ...
        createMuzzleBurst: (position, color, radius, sparks) => this.options.createMuzzleBurst(position, color, radius, sparks),
