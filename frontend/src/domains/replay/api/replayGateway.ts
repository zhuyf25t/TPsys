...
import type { ReplayExportArtifact, ReplayFrame, ReplayHeroFrame, ReplayPlayback } from "../objects/replayTypes";
import { getCurrentAuthUser } from "../../identity/api/authGateway";
import { getReplayEntries, getReplayEntryById, isReplayEntryBackendSyncDisabled } from "../../battle/runtime/local/state/battleTruthStore";
import { loadBattleResultByBattleId, type BackendBattleResultRecord } from "../../battle/api/battleResultsApi";
import { normalizePlayableIdentityHandle, normalizePlayerHandleKey } from "../../identity/objects/identityHandlePolicy";
